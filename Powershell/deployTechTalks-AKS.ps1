...
Set-Location ~/projects/ABC2019/k8s/AKS/
...
Set-Location ~/projects/ABC2019/k8s/AKS/TechTalksDB
...
Set-Location ~/projects/ABC2019/k8s/AKS/TechTalksAPI
kubectl apply --recursive --filename . 
...
Set-Location ~/projects/ABC2019/k8s/AKS/TechTalksWeb
kubectl apply --recursive --filename . 
